...
public class SolutionCopyExceptionTest {
    ...
    public void testConstructor1() {
        SolutionCopyException ex = new SolutionCopyException();
    ...
    public void testConstructor2() {
        SolutionCopyException ex = new SolutionCopyException(MSG);
        assertNull(ex.getCause());
    ...
    public void testConstructor3() {
        SolutionCopyException ex = new SolutionCopyException(CAUSE);
    ...
    public void testConstructor4() {
        SolutionCopyException ex = new SolutionCopyException(MSG, CAUSE);
        assertEquals(CAUSE, ex.getCause());
        assertEquals(MSG, ex.getMessage());
    }
