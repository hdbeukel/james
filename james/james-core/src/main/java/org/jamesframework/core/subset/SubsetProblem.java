...
public class SubsetProblem<DataType extends IntegerIdentifiedData> extends AbstractProblem<SubsetSolution, DataType> {
     ...
     * </p>
     * <p>
     * The given comparator <code>orderOfIDs</code> is used to impose an order on the IDs in any generated subset solution.
     * This argument may be <code>null</code> in case no order is to be imposed.
     * </p>
     * 
     ...
     * </p>
     * <p>
     * If <code>orderIDs</code> is <code>true</code>, any subset solution generated by this problem will order IDs
     * in ascending order.
     * </p>
     * 
     * @param objective objective function, can not be <code>null</code>
