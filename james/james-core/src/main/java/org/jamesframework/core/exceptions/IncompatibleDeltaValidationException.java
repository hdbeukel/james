...
public class IncompatibleDeltaValidationException extends JamesRuntimeException {
     ...
     */
    public IncompatibleDeltaValidationException(String msg) {
        super(msg);
    }
     ...
     */
    public IncompatibleDeltaValidationException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause other exception that caused this exception
     */
    public IncompatibleDeltaValidationException(String msg, Throwable cause) {
        super(msg, cause);
    }
