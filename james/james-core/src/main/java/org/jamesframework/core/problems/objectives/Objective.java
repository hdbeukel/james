...
public interface Objective<SolutionType extends Solution, DataType> {
     ...
     * @param data underlying data used for evaluation
     * @param <ProblemSolutionType> the actual solution type of the problem that is being solved;
     *                             a subtype of the solution type of both the objective and the applied move
     ...
     */
    default public <ProblemSolutionType extends SolutionType> Evaluation evaluate(Move<? super ProblemSolutionType> move,
                                                                                  ProblemSolutionType curSolution,
